...
describe('AllegatoTemplateTask e2e test', () => {
  ...
  it('should create and save AllegatoTemplateTasks', async () => {
    ...
    await promise.all([
      allegatoTemplateTaskUpdatePage.setIdTemplateTaskInput('5'),
      allegatoTemplateTaskUpdatePage.setTipoAllegatoInput('5'),
      allegatoTemplateTaskUpdatePage.setFormatoInput('5'),
      allegatoTemplateTaskUpdatePage.setIdFileInput('5'),
    ...
    expect(await allegatoTemplateTaskUpdatePage.getIdTemplateTaskInput()).to.eq('5', 'Expected idTemplateTask value to be equals to 5');
    expect(await allegatoTemplateTaskUpdatePage.getTipoAllegatoInput()).to.eq('5', 'Expected tipoAllegato value to be equals to 5');
    expect(await allegatoTemplateTaskUpdatePage.getFormatoInput()).to.eq('5', 'Expected formato value to be equals to 5');
    expect(await allegatoTemplateTaskUpdatePage.getIdFileInput()).to.eq('5', 'Expected idFile value to be equals to 5');
