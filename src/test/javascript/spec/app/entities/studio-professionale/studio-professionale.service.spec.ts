...
describe('Service Tests', () => {
  describe('StudioProfessionale Service', () => {
    let injector: TestBed;
    let service: StudioProfessionaleService;
    let httpMock: HttpTestingController;
    let elemDefault: IStudioProfessionale;
    let expectedResult: IStudioProfessionale | IStudioProfessionale[] | boolean | null;
    ...
    describe('Service methods', () => {
      ...
      it('should create a StudioProfessionale', () => {
        ...
        service.create(new StudioProfessionale()).subscribe(resp => (expectedResult = resp.body));
      ...
      it('should delete a StudioProfessionale', () => {
