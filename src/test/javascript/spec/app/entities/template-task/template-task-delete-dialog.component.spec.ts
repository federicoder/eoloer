...
import { TemplateTaskDeleteDialogComponent } from 'app/entities/template-task/template-task-delete-dialog.component';
import { TemplateTaskService } from 'app/entities/template-task/template-task.service';

describe('Component Tests', () => {
  describe('TemplateTask Management Delete Component', () => {
    let comp: TemplateTaskDeleteDialogComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(TemplateTaskDeleteDialogComponent, '')
        .compileComponents();
