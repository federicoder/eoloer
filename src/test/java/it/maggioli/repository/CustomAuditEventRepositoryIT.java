...
import it.maggioli.config.audit.AuditEventConverter;
import it.maggioli.domain.PersistentAuditEvent;
...
import static it.maggioli.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
