...
public class ProdottoResourceIT {
    ...
    private static final Long DEFAULT_NUOVA_LICENZA = 1L;
    private static final Long UPDATED_NUOVA_LICENZA = 2L;

    private static final Long DEFAULT_RINNOVO_LICENZA = 1L;
    private static final Long UPDATED_RINNOVO_LICENZA = 2L;

    private static final Long DEFAULT_STORAGE = 1L;
    private static final Long UPDATED_STORAGE = 2L;
    ...
    public void getAllProdottos() throws Exception {
        ...
        restProdottoMockMvc.perform(get("/api/prodottos?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].nuovaLicenza").value(hasItem(DEFAULT_NUOVA_LICENZA.intValue())))
            .andExpect(jsonPath("$.[*].rinnovoLicenza").value(hasItem(DEFAULT_RINNOVO_LICENZA.intValue())))
    ...
    public void getProdotto() throws Exception {
        ...
        restProdottoMockMvc.perform(get("/api/prodottos/{id}", prodotto.getId()))
            ...
            .andExpect(jsonPath("$.nuovaLicenza").value(DEFAULT_NUOVA_LICENZA.intValue()))
            .andExpect(jsonPath("$.rinnovoLicenza").value(DEFAULT_RINNOVO_LICENZA.intValue()))
