...
public class RuoloOrganizzazioneResource {
    ...
    public ResponseEntity<RuoloOrganizzazioneDTO> createRuoloOrganizzazione(@Valid @RequestBody RuoloOrganizzazioneDTO ruoloOrganizzazioneDTO) throws URISyntaxException {
    ...
    public ResponseEntity<RuoloOrganizzazioneDTO> updateRuoloOrganizzazione(@Valid @RequestBody RuoloOrganizzazioneDTO ruoloOrganizzazioneDTO) throws URISyntaxException {
