...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            ...
            createCache(cm, it.maggioli.domain.TemplatePratica.class.getName() + ".idTemplates");
            createCache(cm, it.maggioli.domain.TemplateTask.class.getName());
            createCache(cm, it.maggioli.domain.TemplateTask.class.getName() + ".idTemplates");
            ...
            createCache(cm, it.maggioli.domain.PrevisioneTask.class.getName() + ".idTasks");
            ...
            createCache(cm, it.maggioli.domain.PrevisioneEvento.class.getName() + ".idTasks");
