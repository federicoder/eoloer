...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            ...
            createCache(cm, it.maggioli.domain.Pratica.class.getName() + ".ids");
            createCache(cm, it.maggioli.domain.Task.class.getName());
            createCache(cm, it.maggioli.domain.Task.class.getName() + ".ids");
            createCache(cm, it.maggioli.domain.TemplatePratica.class.getName());
            createCache(cm, it.maggioli.domain.TemplatePratica.class.getName() + ".ids");
            createCache(cm, it.maggioli.domain.TemplateTask.class.getName());
            createCache(cm, it.maggioli.domain.TemplateTask.class.getName() + ".ids");
            ...
            createCache(cm, it.maggioli.domain.TipoAllegato.class.getName() + ".ids");
            createCache(cm, it.maggioli.domain.AllegatoTask.class.getName());
            createCache(cm, it.maggioli.domain.AllegatoTask.class.getName() + ".ids");
            ...
            createCache(cm, it.maggioli.domain.Invito.class.getName() + ".ids");
            createCache(cm, it.maggioli.domain.Invitato.class.getName());
            createCache(cm, it.maggioli.domain.UserPersona.class.getName());
            createCache(cm, it.maggioli.domain.UserPersona.class.getName() + ".ids");
            ...
            createCache(cm, it.maggioli.domain.Persona.class.getName() + ".ids");
            createCache(cm, it.maggioli.domain.PersonaFisica.class.getName());
            createCache(cm, it.maggioli.domain.PersonaFisica.class.getName() + ".ids");
            ...
            createCache(cm, it.maggioli.domain.StudioProfessionale.class.getName() + ".ids");
            createCache(cm, it.maggioli.domain.RisorseDisponibili.class.getName());
            createCache(cm, it.maggioli.domain.Ordine.class.getName());
            createCache(cm, it.maggioli.domain.Ordine.class.getName() + ".ids");
