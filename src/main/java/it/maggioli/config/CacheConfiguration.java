...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            ...
            createCache(cm, it.maggioli.domain.PrevisioneTask.class.getName() + ".idPrevisioneTasks");
            ...
            createCache(cm, it.maggioli.domain.PrevisioneEvento.class.getName() + ".idInvitoEventos");
            ...
            createCache(cm, it.maggioli.domain.AssegnazioneTask.class.getName() + ".idInvitos");
